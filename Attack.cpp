...
Attack::Attack(DATA location, DATA size, DATA speed, float duration_time, int attack_power, int* attack_image, int image_num) :
	BoxCollider(location, size),duration_time(duration_time),speed(speed),attack_power(attack_power), attack_image(attack_image),
	image_num(image_num), draw_image_num(0), image_change_time(0.0f)
{
