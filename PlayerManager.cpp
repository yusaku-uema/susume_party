...
void PlayerManager::Initialize(class Stage* stage, class EnemyManager* enemy_manager, class AttackManager* attack_manager)
{
	...
	player[0] = new Hero(stage, this, enemy_manager, attack_manager);//勇者
	player[1] = new Warrior(stage, this, enemy_manager, attack_manager);//戦士
	player[2] = new Wizard(stage, this, enemy_manager, attack_manager);//魔法使い
	player[3] = new Monk(stage, this, enemy_manager, attack_manager); //僧侶
